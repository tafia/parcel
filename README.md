## Is everything too slow?<br>You're still beating the bundler?<br>You want to try those fancy new module things?<br>[Parcel Redux](https://github.com/nathan/parcel-redux) will solve all your problems!
